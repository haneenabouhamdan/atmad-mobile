/**
 * ISO 3166-1 country list with E.164 dial codes for the phone entry
 * picker. Flag emojis use the regional indicator pair so they render
 * automatically on iOS / Android without any additional assets.
 *
 * `popular` floats a small set of destinations to the top of the list
 * so most users see their country without scrolling.
 */
export interface Country {
  /** ISO 3166-1 alpha-2 (e.g. "AE"). Used as a stable key. */
  code: string;
...
export const POPULAR_COUNTRY_CODES = ["AE", "SA", "QA", "KW", "BH", "OM", "GB", "US"] as const;
...
export const DEFAULT_COUNTRY: Country =
  findCountryByCode("AE") ?? COUNTRIES[0];
